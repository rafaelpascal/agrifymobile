            ...
            <>
              {ispassWord ? (
                <>
                  {isConfirmPass ? (
                    <>
                      <View className="h-[80vh] w-full p-4">
                        <TouchableOpacity
                        ...
                        <View className="h-auto mt-3 w-full flex justify-start items-start">
                    ...
                    <>
                      <View className="h-[80vh] w-full p-4">
                        ...
                        <View className="h-auto w-full mt-3 flex justify-start items-start">
                          <Text className="text-[24px] font-bold text-[#343434] font-DMSans">
                            Secure your new account
                          </Text>
                          <View className="w-full mt-[10px] h-[400px] flex justify-start items-start">
                ...
                <>
                  <View className="h-[80vh] w-full p-4">
                    ...
                    <View className="h-auto mt-4 w-full flex justify-start items-start">
                      <Text className="text-[24px] font-bold text-[#343434] font-DMSans">
            ...
            <>
              <View className="h-full w-full flex justify-evenly items-start p-4">
                <TouchableOpacity className="bg-themeGreen/10 border-[1px] border-themeGreen w-[78px] h-[35px] flex flex-row items-center justify-center rounded-[8px]">
                  ...
                  <Link
                    href="/"
                    className="text-[14px] ml-2 p-0 text-[#2F2F2F] font-normal"
                  >
                    Go Back
                  </Link>
                </TouchableOpacity>
                <View className="h-auto mt-3 z-10 w-full flex justify-start items-start">
                  <Text className="text-[24px] font-bold text-[#343434] font-DMSans">
                ...
                <View className="h-[38px] mt-4 z-0 w-full flex justify-center flex-row items-center">
